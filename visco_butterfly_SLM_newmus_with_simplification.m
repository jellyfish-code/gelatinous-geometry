%{
======================================================================
    Main function evolving jellyfish butterfly mesh. With simplifications in viscoelastic edge, as stated in Supplementary Text. 
======================================================================
...
function visco_butterfly_SLM_newmus_with_simplification(time_step, time_end, elast0, elast1, vis, damping_coefficient, bulk_modulus, area0, muscle_strain, contraction_rate, max_dR, dR_rate, folder_save, datapath)
%% Set up parameters, everything in Pa(N/m^2) and s
    ...
    %% Calculate the Maxwell relaxation constant. Used to update relaxed length of spring 1 in series with dashpot.
   ...
   %%Setup takes about 4 seconds%%%
    ...
    for time = 1:time_steps
        ...
        % Update relaxed length of spring 1.
