...
dR_rate = 0.15; 
area0 = 1.001; 
visco_offset_SLM_newmus_remote_version(elast0, elast1, vis, bulk_modulus, area0, muscle_strain, contraction_rate, max_dR, dR_rate, offset, folder_save, datapath)
% visco_offset_SLM_newmus_original(elast0, ...
%                         elast1, ...
%                         vis, ...
%                         bulk_modulus, ...
%                         area, ...
...
%                         folder_save, ...
%                         datapath);
% elast0, elast1, vis, bulk_modulus, area0, muscle_strain, contraction_rate, offset, folder_save
